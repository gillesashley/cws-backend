    ...
    <div class="login-bg-overlay au-sign-up-basic">
        <div>
            <div class="container-fluid">
                <a href="javascript:;"><img src="{{ asset('assets/images/logo-icon-3.png') }}" width="140"
                        alt=""></a>
            </div>
        </div>
                            ...
                            <form class="row g-3" method="POST" action="{{ route('login') }}">
                                ...
                                <div class="col-12 col-lg-12">
                                    <div class="d-grid gap-2">
                                        <a href="javascript:;" class="btn border border-2 border-primary">
                                            <img src="{{ asset('assets/images/icons/google.png') }}" width="20"
                                                alt="">
                                            <span class="ms-3 fw-500">Sign in with Google</span>
                                        </a>
                                        <a href="javascript:;" class="btn border border-2 border-dark">
                                            <img src="{{ asset('assets/images/icons/apple-black-logo.png') }}"
                                                width="20" alt="">
                                ...
                                <div class="col-12 col-lg-6 text-end">
                                    <a href="{{ route('password.request') }}"
                                        style="pointer-events: none; color: gray; text-decoration: none;">Forgot
                                        Password?</a>
                                </div>
                                ...
                                <div class="col-12 col-lg-12 text-center">
                                    <p class="mb-0">Don't have an account? <a href="{{ route('register') }}"
                                            style="pointer-events: none; color: gray; text-decoration: none;">Sign up</a>
                                    </p>
                                </div>
                            </form>
                        </div>
