        ...
        <div class="col-12 col-lg-4 col-xl-4">
            <div class="card radius-10">
              <div class="card-body" style="position: relative;">
                ...
                <div class="mt-3" id="chart2" style="min-height: 70px;">
{{--                    <div id="apexchartsqmkbcfy8" class="apexcharts-canvas apexchartsqmkbcfy8 apexcharts-theme-light" style="width: 268px; height: 70px;">--}}
