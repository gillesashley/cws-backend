        ...
        <aside class="sidebar-wrapper" data-simplebar="true">
            ...
            <ul class="metismenu" id="menu">
                ...
                <li>
                    ...
                    <ul>
                        <li><a href="ecommerce-shop-grid-view.html"><ion-icon name="ellipse-outline"></ion-icon>Product
                                Grid</a>
                        </li>
                        <li><a href="ecommerce-shop-list-view.html"><ion-icon name="ellipse-outline"></ion-icon>Product
                                List</a>
                        </li>
                        <li><a href="ecommerce-shop-grid-view-top-filter.html"><ion-icon
                                    name="ellipse-outline"></ion-icon>Product Top Filters</a>
                        </li>
                        <li><a href="ecommerce-product-details.html"><ion-icon name="ellipse-outline"></ion-icon>Product
                                Details</a>
                        </li>
                        <li><a href="ecommerce-product-comparison.html"><ion-icon
                                    name="ellipse-outline"></ion-icon>Product Comparison</a>
                        </li>
                        <li><a href="ecommerce-shop-cart.html"><ion-icon name="ellipse-outline"></ion-icon>Shoping
                                Cart</a>
                        </li>
                        <li><a href="ecommerce-checkout-details.html"><ion-icon
                                    name="ellipse-outline"></ion-icon>Checkout</a>
                        </li>
                        <li><a href="ecommerce-checkout-shipping.html"><ion-icon
                                    name="ellipse-outline"></ion-icon>Shipping</a>
                        </li>
                        <li><a href="ecommerce-checkout-payment.html"><ion-icon
                                    name="ellipse-outline"></ion-icon>Payment</a>
                        </li>
                        <li><a href="ecommerce-checkout-review.html"><ion-icon name="ellipse-outline"></ion-icon>Review
                                Cart</a>
                        </li>
                        <li><a href="ecommerce-checkout-complete.html"><ion-icon name="ellipse-outline"></ion-icon>Order
                                Complete</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul>
                        <li> <a href="widgets-static-widgets.html"><ion-icon name="ellipse-outline"></ion-icon>Static
                                Widgets</a>
                        </li>
                        <li> <a href="widgets-data-widgets.html"><ion-icon name="ellipse-outline"></ion-icon>Data
                                Widgets</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li> <a href="component-accordions.html"><ion-icon
                                    name="ellipse-outline"></ion-icon>Accordions</a>
                        </li>
                        ...
                        <li> <a href="component-carousels.html"><ion-icon
                                    name="ellipse-outline"></ion-icon>Carousels</a>
                        </li>
                        <li> <a href="component-list-groups.html"><ion-icon name="ellipse-outline"></ion-icon>List
                                Groups</a>
                        </li>
                        <li> <a href="component-media-object.html"><ion-icon name="ellipse-outline"></ion-icon>Media
                                Objects</a>
                        </li>
                        <li> <a href="component-modals.html"><ion-icon name="ellipse-outline"></ion-icon>Modals</a>
                        </li>
                        <li> <a href="component-navs-tabs.html"><ion-icon name="ellipse-outline"></ion-icon>Navs &
                                Tabs</a>
                        </li>
                        <li> <a href="component-paginations.html"><ion-icon
                                    name="ellipse-outline"></ion-icon>Pagination</a>
                        </li>
                        <li> <a href="component-popovers-tooltips.html"><ion-icon
                                    name="ellipse-outline"></ion-icon>Popovers & Tooltips</a>
                        </li>
                        <li> <a href="component-progress-bars.html"><ion-icon
                                    name="ellipse-outline"></ion-icon>Progress</a>
                        </li>
                        <li> <a href="component-spinners.html"><ion-icon
                                    name="ellipse-outline"></ion-icon>Spinners</a>
                        </li>
                        <li> <a href="component-notifications.html"><ion-icon
                                    name="ellipse-outline"></ion-icon>Notifications</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul>
                        <li> <a href="icons-line-icons.html"><ion-icon name="ellipse-outline"></ion-icon>Line
                                Icons</a>
                        </li>
                        <li> <a href="icons-boxicons.html"><ion-icon name="ellipse-outline"></ion-icon>Boxicons</a>
                        </li>
                        <li> <a href="icons-feather-icons.html"><ion-icon name="ellipse-outline"></ion-icon>Feather
                                Icons</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul>
                        <li> <a href="form-elements.html"><ion-icon name="ellipse-outline"></ion-icon>Form
                                Elements</a>
                        </li>
                        <li> <a href="form-input-group.html"><ion-icon name="ellipse-outline"></ion-icon>Input
                                Groups</a>
                        </li>
                        <li> <a href="form-layouts.html"><ion-icon name="ellipse-outline"></ion-icon>Forms Layouts</a>
                        </li>
                        <li> <a href="form-validations.html"><ion-icon name="ellipse-outline"></ion-icon>Form
                                Validation</a>
                        </li>
                        <li> <a href="form-date-time-pickes.html"><ion-icon name="ellipse-outline"></ion-icon>Date
                                Pickers</a>
                        </li>
                ...
                <li>
                    ...
                    <ul>
                        <li> <a href="table-basic-table.html"><ion-icon name="ellipse-outline"></ion-icon>Basic
                                Table</a>
                        </li>
                        <li> <a href="table-advance-tables.html"><ion-icon name="ellipse-outline"></ion-icon>Advance
                                Tables</a>
                        </li>
                ...
                <li>
                    ...
                    <ul>
                        <li> <a href="authentication-sign-in-basic.html" target="_blank"><ion-icon
                                    name="ellipse-outline"></ion-icon>Sign In Basic</a>
                        </li>
                        <li> <a href="authentication-sign-in-cover.html" target="_blank"><ion-icon
                                    name="ellipse-outline"></ion-icon>Sign In Cover</a>
                        </li>
                        <li> <a href="authentication-sign-in-simple.html" target="_blank"><ion-icon
                                    name="ellipse-outline"></ion-icon>Sign In Simple</a>
                        </li>
                        <li> <a href="authentication-sign-up-basic.html" target="_blank"><ion-icon
                                    name="ellipse-outline"></ion-icon>Sign Up Basic</a>
                        </li>
                        <li> <a href="authentication-sign-up-cover.html" target="_blank"><ion-icon
                                    name="ellipse-outline"></ion-icon>Sign Up Cover</a>
                        </li>
                        <li> <a href="authentication-sign-up-simple.html" target="_blank"><ion-icon
                                    name="ellipse-outline"></ion-icon>Sign Up Simple</a>
                        </li>
                        <li> <a href="authentication-reset-password-basic.html" target="_blank"><ion-icon
                                    name="ellipse-outline"></ion-icon>Reset Password Basic</a>
                        </li>
                        <li> <a href="authentication-reset-password-cover.html" target="_blank"><ion-icon
                                    name="ellipse-outline"></ion-icon>Reset Password Cover</a>
                        </li>
                        <li> <a href="authentication-reset-password-simple.html" target="_blank"><ion-icon
                                    name="ellipse-outline"></ion-icon>Reset Password Simple</a>
                        </li>
                    </ul>
                </li>
                <li>
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li><a href="pages-pricing-tables.html"><ion-icon
                                    name="ellipse-outline"></ion-icon>Pricing</a>
                        </li>
                        <li><a href="pages-errors-404-error.html"><ion-icon name="ellipse-outline"></ion-icon>404
                                Error</a>
                        </li>
                        <li><a href="pages-errors-500-error.html"><ion-icon name="ellipse-outline"></ion-icon>500
                                Error</a></li>
                        <li><a href="pages-errors-coming-soon.html"><ion-icon name="ellipse-outline"></ion-icon>Coming
                                Soon</a></li>
                        <li><a href="pages-starter-page.html"><ion-icon name="ellipse-outline"></ion-icon>Blank
                                Page</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul>
                        <li> <a href="map-google-maps.html"><ion-icon name="ellipse-outline"></ion-icon>Google
                                Maps</a>
                        </li>
                        <li> <a href="map-vector-maps.html"><ion-icon name="ellipse-outline"></ion-icon>Vector
                                Maps</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul>
                        <li> <a class="has-arrow" href="javascript:;"><ion-icon
                                    name="ellipse-outline"></ion-icon>Level One</a>
                            <ul>
                                <li> <a class="has-arrow" href="javascript:;"><ion-icon
                                            name="ellipse-outline"></ion-icon>Level Two</a>
                                    <ul>
                                        <li> <a href="javascript:;"><ion-icon name="ellipse-outline"></ion-icon>Level
                                                Three</a>
                                        </li>
                                    </ul>
                                </li>
                ...
                <div class="row">
                                    ...
                                    <table class="table table-borderless align-middle mb-0">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="w-100">
                                                    <div class="progress flex-grow-1" style="height: 6px;">
                                                        <div class="progress-bar bg-gradient-purple"
                                                ...
                                                <td class="w-100">
                                                    <div class="progress flex-grow-1" style="height: 6px;">
                                                        <div class="progress-bar bg-gradient-danger"
                                                            role="progressbar" style="width: 24%;"></div>
                                                    </div>
                                                </td>
                                                <td>
                    ...
                    <div class="col-12 col-lg-12 col-xl-6 d-flex">
                        <div class="card radius-10 w-100">
                            <div class="card-body">
                                <div
                                    class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-xl-2 row-cols-xxl-2 g-3">
                                    <div class="col">
