...
<div class="container">
    ...
    <form action="{{ route('targeted-messages.whatsapp.store') }}" method="POST">
        @csrf
        ...
        <div class="form-group">
            ...
            <textarea name="content" id="content" class="form-control" rows="3" required maxlength="160">{{ old('content') }}</textarea>
        </div>
